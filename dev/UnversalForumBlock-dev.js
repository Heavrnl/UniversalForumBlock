...
(function() {
    ...
    function createSettingsPanel() {
        ...
        settingsPanel.innerHTML = `
            ...
            <div class="setting-group">
                <label>展开宽度</label>
                <input type="range" id="expanded-width" min="100" max="${/Mobile|Android|iPhone/i.test(navigator.userAgent) ? Math.min(window.innerWidth * 0.9, 290) : 1000}" step="10" value="${PANEL_SETTINGS.expandedWidth}">
